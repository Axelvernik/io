...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg gan-bg text-neutral-content border-b border-zinc-600 bg-opacity-66">
        ...
        <div className="navbar-end">
          ...
          <NavElement
            ...
            navigationStarts={() => setIsNavOpen(false)}
          />
          <WalletMultiButtonDynamic className="btn-ghost btn-sm rounded-btn text-xl mr-6 " />
        </div>
          <label
              htmlFor="my-drawer"
      ...
      <div>
        <span className="absolute block h-0.5 w-12 bg-white rotate-90 right-14"></span>
      </div>
